export function getCityBySearchString(searchString) {
  const cityList = [
    "abadia dos dourados",
    "abadiania",
    "abaete",
  ...
  if (!searchString) return cityList.slice(0, 10); // Return the first 10 cities if no search string is provided.

  const lowerSearchString = searchString.toLowerCase();

  // Filter the cityList and limit the results to 10
  return cityList
    .filter((city) => city.toLowerCase().includes(lowerSearchString))
    .slice(0, 10);
}

export function getProductCategoryBySearchString(searchString) {
  ...
  if (!searchString) return productCategoryList.slice(0, 10); // Return the first 10 categories if no search string is provided.

  const lowerSearchString = searchString.toLowerCase();

  // Filter the productCategoryList and limit the results to 10
  return productCategoryList
    .filter((category) => category.toLowerCase().includes(lowerSearchString))
    .slice(0, 10);
}
